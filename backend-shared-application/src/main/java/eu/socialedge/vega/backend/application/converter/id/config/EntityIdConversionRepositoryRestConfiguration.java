 ...
 */
package eu.socialedge.vega.backend.application.converter.id.config;

import eu.socialedge.vega.backend.application.converter.id.*;
...
@Configuration
@ComponentScan("eu.socialedge.vega.backend.application.converter.id")
public class EntityIdConversionRepositoryRestConfiguration extends RepositoryRestConfigurerAdapter {
    ...
    public void configureConversionService(ConfigurableConversionService conversionService) {
        ...
        conversionService.addConverter(new ZoneIdConverter());
    }
}
